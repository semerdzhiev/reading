...
https://stackoverflow.com/questions/23303549/what-are-commit-ish-and-tree-ish-in-git[What are commit-ish and tree-ish in Git?]
...
https://docs.gitlab.com/ee/ssh/[GitLab and SSH keys] | GitLab
