...
https://git-scm.com/docs/gitglossary[gitglossary - A Git Glossary]
...
https://git-scm.com/docs/git-check-ref-format[`git-check-ref-format`]
...
.Scott Chacon, Ben Straub. Git - Book
* https://git-scm.com/book/en/v2/Git-Basics-Tagging[Chapter 2.6: Tagging]

https://git-scm.com/docs/git-tag[`git tag`]

https://stackoverflow.com/questions/4971746/why-should-i-care-about-lightweight-vs-annotated-tags[Why should I care about lightweight vs. annotated tags?] | Stack Overflow

=== Information about the index and the tree objects
...
https://git-scm.com/docs/gitattributes[gitattributes - Defining attributes per path]

https://stackoverflow.com/questions/10418975/how-to-change-line-ending-settings[How to change line-ending settings] | Stack Overflow
...
https://en.wikibooks.org/wiki/Regular_Expressions/POSIX_Basic_Regular_Expressions[Regular Expressions/POSIX Basic Regular Expressions] | WikiBooks
...
https://medium.com/better-programming/why-and-how-you-should-sign-all-your-git-commits-94435516edae[Why and How You Should Sign All Your Git Commits]] | Richard Dubniczky (2022)
...
https://martinfowler.com/articles/branching-patterns.html[Patterns for Managing Source Code Branches] | Martin Fowler

https://martinfowler.com/articles/continuousIntegration.html[Continuous Integration] | Martin Fowler
